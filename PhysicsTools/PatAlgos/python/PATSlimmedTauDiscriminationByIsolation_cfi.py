...
patSlimmedTauDiscriminationByIsolation = cms.EDProducer("PATSlimmedTauDiscriminationByIsolation",
    PATTauProducer = cms.InputTag('slimmedTaus'), #tau collection to discriminate
