        ...
        if "deepTau2017v2p1" in self.toKeep:
            ...
            deepTauSonicTriton.toReplaceWith(_deepTauProducer, DeepTauIdSonicProducer.clone(
                Client = cms.PSet(
                  ...
                  modelConfigPath = cms.FileInPath("RecoTauTag/RecoTau/data/models/deeptau_2017v2p1/config.pbtxt"),
        ...
        if "deepTau2018v2p5" in self.toKeep:
            ...
            deepTauSonicTriton.toReplaceWith(_deepTauProducer, DeepTauIdSonicProducer.clone(
                Client = cms.PSet(
                  ...
                  modelVersion = cms.string(''),
                  modelConfigPath = cms.FileInPath("RecoTauTag/RecoTau/data/models/deeptau_2018v2p5/config.pbtxt"),
                  preferredServer = cms.untracked.string(''),
                  timeout = cms.untracked.uint32(300),
                  useSharedMemory = cms.untracked.bool(True),
                  compression = cms.untracked.string(''),
