#ifndef RecoTauTag_RecoTau_DeepTauHelper_h
#define RecoTauTag_RecoTau_DeepTauHelper_h

/*
 * \class DeepTauHelper
 *
 * Class used to store shared code between DeepTauIdProducer (direct inference)
 * and DeepTauIdSonicProducer (Sonic aaS)
 *
 */
